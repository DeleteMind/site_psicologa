...
export default function SobrePage() {
  return (
    <main className="text-black text-lg flex justify-center p-4 sm:p-12">
      <section className="flex flex-col lg:flex-row gap-4">
        {/* Title */}
        <div className=" relative flex flex-col gap-4 sm:gap-16 lg:w-1/2 mt-20">
          <h1 className=" absolute left-20 text-4xl sm:text-8xl">Daniela Santos <br /> Sousa</h1>
          <div className=" p-8 mt-64 space-y-2 sm:space-y-4">
        ...
        {/* Image and about */}
        <section className="mt-20 flex flex-col gap-4 sm:gap-8 w-full lg:w-1/2">
          <Image
          ...
          />
          <div className="mr-10 space-y-2 sm:space-y-4 text-justify">
