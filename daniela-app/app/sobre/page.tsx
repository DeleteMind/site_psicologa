    ...
    <main className=" text-lg min-h-screen p-8 sm:p-16 lg:mx-4 xl:mx-8">
      ...
      <div className="p-4 flex flex-col-reverse md:flex-row w-full lg:w-3/4 justify-start items-center lg:items-end mx-auto gap-x-16">
        ...
        <Image
          ...
          className="rounded-full shadow-md w-full max-w-[450px] h-auto object-cover bg-white p-1 aspect-square"
        />
      </div>

      {/* Section at the bottom */}
      <section className="mt-10 pt-8  text-justify  border-t-2 gap-x-8">
        <h3 className="mb-2 text-2xl p-4">A PSICÓLOGA QUE SOU</h3>
        <div className="flex flex-col lg:w-2/3 bg-white/90 rounded-2xl shadow-md p-4 text-xs sm:text-sm lg:text-lg">
          ...
          <a href="/Curriculum_DanielaSousa_PsicólogaClinica.pdf" target="_blank" rel="pdf_File" className='flex flex-row items-center justify-end gap-4 mt-4'>
            <img src="/Icons/pdf.png" alt='pdfIcons' className='w-6 h-6 sm:w-8 sm:h-8'></img>Currículo
          </a>
        </div>
      </section>
    </main>
