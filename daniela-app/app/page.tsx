  ...
  return (
    <main className="flex flex-col items-center justify-center w-full">
      ...
      <div className="flex flex-col lg:flex-row items-center justify-center m-8">
        <div className=" bg-white h-96 p-8 flex flex-col gap-4 w-full lg:max-w-lg mt-8 transform lg:translate-x-6">
          ...
          <button className="absolute bottom-6  text-zinc-500 border-2 border-orange-50 px-4 py-2 rounded-sm  hover:bg-orange-50 hover:text-orange-900">Saber mais</button>
        </div>
        <Image
          className=""
          src="/pexels-alex-green-5699456 (1).jpg"
